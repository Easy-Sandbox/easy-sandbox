...
@click.group(
    ...
    lazy_subcommands={
        ...
        "session": "easy_sandbox.cli.commands.session:session",
        "secret": "easy_sandbox.cli.commands.secret:secret",
        "skill": "easy_sandbox.cli.commands.skill:skill",
        "auth": "easy_sandbox.cli.commands.auth:auth",
    },
)
