...
from serverless_sandbox.models.process import CodeResult, ProcessResult
...
from serverless_sandbox.transport.config import TransportConfig, load_config
...
class Sandbox:
    ...
    async def create(
        ...
        *,
        ...
        if description and template == "base":
            from serverless_sandbox.agent.infer import infer_template  # lazy import
    ...
    async def deploy(
        ...
        *,
        ...
        """
        from serverless_sandbox.api.deploy import DeployModule, resolve_llm_env
...
from serverless_sandbox.api.code import CodeContextModule as CodeContextModule  # noqa: E402
from serverless_sandbox.api.commands import CommandsModule as CommandsModule  # noqa: E402
from serverless_sandbox.api.files import FilesModule as FilesModule  # noqa: E402
from serverless_sandbox.api.network import NetworkModule as NetworkModule  # noqa: E402
from serverless_sandbox.protocol.terminal import TerminalSession as TerminalSession  # noqa: E402
